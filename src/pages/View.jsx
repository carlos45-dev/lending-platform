...
function View() {
  ...
  const approveLoan = async () => {
    ...
    const message = `Hey I'm ${currentUser.username || 'a lender'}, I want to approve the loan that you applied on UniFund. The loan amounting MWK ${request.amount} for ${request.weeks} ${request.weeks === 1 ? 'week' : 'weeks'}.`;
